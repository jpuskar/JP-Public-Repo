...
Install-CertificationAuthority -CAName "Chemistry Issuing CA1" -CSP "RSA#Microsoft Software Key Storage Provider" -CADNSuffix "dc=chemistry,dc=ohio-state,dc=edu" -CAType "Enterprise Subordinate" -HashAlgorith SHA256 -DBDirectory "D:\db-cert" -LogDirectory "E:\log-cert"
