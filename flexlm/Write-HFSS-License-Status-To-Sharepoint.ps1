...
$logfile = "C:\scripts\hfss-status.log"
...
$webListPage = $null
$webListPage = "https://sharepoint1.osuesl.net/sites/esl-it/Lists/HFSS License Status Page/AllItems.aspx"
...
$listName = "HFSS License Status Page"
